<?php
require_once('resources/hits.php');
?>
...
?>
  ...
  <source src="/img/sake.mp4" type="video/mp4" style= z-index: -1;>
...
if ($handle = opendir('.')) {
  while (false !== ($file = readdir($handle))){
    if ($file != "." &&  $file != "index.php" &&  $file != ".htaccess"  &&  $file != "admin"  &&  $file != "db"  &&  $file != "img"   &&  $file != "php-b.py"   &&  $file != "php-b2.py" &&  $file != "resources"  &&  $file != "php-a1.py"  &&  $file != "php-a2.py" ){
...
<?php
if ($_GET['newdir2']) {
  exec("python3 php-a2.py");
}
?>
<div style="padding-left:75rem;">
<a href="?newdir2=true">Change OpenDir!</a>
</div>
